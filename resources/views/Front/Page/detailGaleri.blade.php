    ...
    <div class=" pt-24 lg:flex bg-slate-50">
            ...
            <section class=" ">
                ...
                <div class=" pt-2 pl-4 pb-3 lg:pb-0">
                    @foreach ($kategoriGaleri as $row)
                        <a href="">
                            <p class=" lg:pl-11 font-Poppins font-semibold" style="letter-spacing: 1px;">>
                                {{ $row->kategori }}
                            </p>
                        </a>
                    @endforeach
        ...
        <div class="">
            <div class=" bg-white">
                ...
                <div class=" p-4 pl-6">
                    <p class=" font-Rasa font-bold text-black text-2xl">Galeri detail <span class=" text-xl">“Winter
                            Series”</span></p>
                    <p class=" font-Poppins font-bold">6 Negara <span>(Italia, Swiss, Jerman, Belanda, Belgia,
                            Perancis)</span></p>
                </div>

                <div class=" grid lg:grid-cols-2 p-6 gap-7">
                    <div>
                        <a href="" class=""><img
                                class=" rounded-lg w-full h-full object-cover hover:opacity-50 transition-opacity duration-300"
                                width="100%" height="50%" src={{ asset('img/galeri.png') }} alt="Logo UMT"></a>
                    </div>
                    <div class=" bg-537938 rounded-lg">
                        <p class=" font-Poppins text-white p-5" style="font-weight: 500;">Di dalam Tour Amazing Europe
                            edisi Winter Series mengunjungi sebuah situs bersejarah yaitu,
                            Piramida Louvre. Bangunan ini merupakan sebuah piramida kaca dan besi besar, dikelilingi
                            oleh tiga piramida kecil, di taman Museum Louvre (Musée du Louvre) di Paris, Prancis.
                            Piramida utama berperan sebagai pintu masuk utama ke museum. Selesai dibangun tahun 1989,[1]
                            bangunan ini menjadi markah tanah bagi kota Paris.
                        </p>
                    </div>
                </div>
            ...
            <div class=" grid lg:grid-cols-4 grid-cols-2 rounded-lg pt-2 px-2">
                ...
                <div class="p-2">
                    <a href=""><img
                            class=" rounded-lg w-full h-full object-cover hover:opacity-50 transition-opacity duration-300"
                            width="100%" height="50%" src={{ asset('img/paris.png') }} alt="Logo UMT"></a>
                ...
                <div class="p-2">
                    <a href=""> <img
                            class=" rounded-lg w-full h-full object-cover hover:opacity-50 transition-opacity duration-300"
                            width="100%" height="50%" src={{ asset('img/wah.png') }} alt="Logo UMT"></a>
                ...
                <div class="p-2">
                    <a href=""><img
                            class=" rounded-lg w-full h-full object-cover hover:opacity-50 transition-opacity duration-300"
                            width="100%" height="50%" src={{ asset('img/foto2.png') }} alt="Logo UMT"></a>
