            ...
            <div class="flex items-center justify-between relative p-5">
                ...
                <div class="flex items-center">
                    ...
                    <nav id="nav-menu"
                        class="hidden absolute bg-white shadow-lg rounded-lg max-w-[250px] w-full right-4 top-full lg:block lg:static lg:bg-transparent lg:max-w-full lg:shadow-none lg:rounded-none mr-">
                        <ul id="menu"
                            class="  block  lg:flex mr-14 rounded-full lg:bg-e2f0d9 uppercase font-Poppins text-537938 font-semibold text-base py-1">
                            <li class="group">
                                <a href="{{ route('front.index') }}"
                                    class="text-base text-dark py-1 mx-5 px-2 flex group-hover:text-primary rounded-full hover:bg-537938 transition duration-300 ease-in-out hover:text-white">Beranda</a>
                            </li>
                            ...
                            <li class="group">
                                <a href="{{ route('login') }}"
                                    class="text-base text-dark py-1 mx-5 px-2 flex group-hover:text-primary rounded-full hover:bg-537938 transition duration-300 ease-in-out hover:text-white">Gallery</a>
                            </li>
                            <li class="group">
                                <a href="{{ route('login') }}"
                                    class="text-base text-dark py-1 mx-5 px-2 flex group-hover:text-primary rounded-full hover:bg-537938 transition duration-300 ease-in-out hover:text-white">Product</a>
                ...
                <p class=" bg-e2f0d9 text-537938 font-bold px-2 py-2" style="border-radius: 10px; font-size:16px;">{{ Auth::user()->name }}<a href="" onclick="confirmLogout(event)" title="Logout" class=" bg-e2f0d9 text-537938 px-3 py-2 mr-6 lg:mr-0" style="border-radius: 10px;"><i class="fa-solid fa-right-from-bracket" style="color: black;"></i></a></p>
    ...
    <div class=" pt-24 lg:flex bg-e9ede7">
        ...
        <div class="">
            <section class=" ">
                ...
                <form class="max-w-md mx-auto px-10">
        ...
        <div class="">
            ...
            <div class=" bg-white">
                ...
                <div class=" pb-4">
                    <h1 class=" text-center font-Rasa font-bold pt-12" style="font-size: 1.6rem;">Yuk! Cari tau
                        berbagai Destinasi di seluruh dunia</h1>
                    <div class=" grid grid-cols-2 rounded-full p-4">
                        <img class=" w-full px-8 py-6 rounded-lg" style="border-radius: 50px;" width="100%"
                            height="100%" src={{ asset('img/view.jpg') }} alt="Logo UMT">
                        <img class="px-8 py-6" style="border-radius: 50px;" width="90%" height="100%"
                            src={{ asset('img/view5.jpg') }} alt="Logo UMT">
                    </div>
                ...
                {{-- <div class=" text-end justify-end mr-8">
                    <a href=""><u class=" font-Poppins font-semibold hover:text-65894b">Artikel Lengkap ></u></a>
                </div> --}}

                {{-- <div class=" p-4 pl-6 pt-10">

                    <p class=" font-Rasa font-bold text-black text-2xl px-3">Australia</p>
                    <p class=" font-Poppins pt-4 p-3">oke</p>
