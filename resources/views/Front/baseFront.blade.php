...
<style>
    ...
    @keyframes bgChange {
        0% {
            background-image: url('{{ asset('img/front1.jpg') }}');
        }
...
<body>
            ...
            <div class="container">
                ...
                <div class="flex items-center justify-between relative p-5">
                    ...
                    <div class="flex items-center">
                        ...
                        <nav id="nav-menu"
                            ...
                            <ul id="menu"
                                ...
                                <li class="group">
                                    <a href="{{ route('front.index') }}"
                                        class="text-base text-dark lg:py-1 my-1 mx-5 px-2 flex group-hover:text-primary rounded-md hover:bg-537938 transition duration-300 ease-in-out hover:text-white">Beranda</a>
                                </li>
                                <li class="group">
                                    <a href="{{ route('front.view.destinasi') }}"
                                        class="text-base text-dark lg:py-1 my-1 mx-5 px-2 flex group-hover:text-primary rounded-md hover:bg-537938 transition duration-300 ease-in-out hover:text-white">Destinasi</a>
                                </li>
                                @guest
                                <button id="dropdownHoverButton" data-dropdown-toggle="dropdownHover"
                                data-dropdown-trigger="hover"
                                class="hover:text-white -ml-28 uppercase text-base font-Poppins font-semibold lg:bg-e2f0d9 hover:bg-537938 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg px-5 lg:text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                            ...
                            <div id="dropdownHover"
                                class="z-10 hidden ml-10 bg-white divide-y divide-gray-100 rounded-lg w-44 ">
                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" id="topOfPage"
                            ...
                            {{-- end dropdown galeri --}}
                                    <li class="group">
                                        <a href="{{ route('login') }}"
                                            class="text-base text-dark lg:py-1 mx-5 my-1 px-2 flex group-hover:text-primary rounded-md hover:bg-537938 transition duration-300 ease-in-out hover:text-white">Product</a>
                                    </li>
                                @else
                                ...
                                <li class="group">
                                    <a href="{{ route('front.hubungi.kami') }}"
                                        class="text-base text-dark lg:py-1 mx-5 my-1 px-2 flex group-hover:text-primary rounded-md hover:bg-537938 transition duration-300 ease-in-out hover:text-white">Hubungi
                                        Kami</a>
                                </li>
                    ...
                    @else
                        ...
                        <p class=" bg-e2f0d9 mt-1 text-537938 font-bold px-2 py-2 mr-14" style="border-radius: 10px; font-size:16px;">
        ...
        <section id="destinasi" class="  md:-mt-20 lg:mt-0">
            ...
            <section class="a relative p-10 lg:p-0 lg:-mt-0 -mt-11">
                <div class="wrapper lg:mx-auto lg:-mt-20 -mt-40 z-10" style="margin-top: -6rem">
                    ...
                    <ul data-aos="fade-up" data-aos-duration="3000" class="carousel lg:p-4 sm:py-4">
                            ...
                            <a href="{{ route('front.desc.destinasi', $row->id) }}">
                                <li class="card relative">
                                    <div class="a rounded-lg object-cover transform transition duration-500 hover:scale-110"
                                        ...
                                        <img src="{{ asset('storage/' . $row->img) }}" alt="img"
                                            draggable="false" style="height: 355px; width: 300px;"
                                            class=" rounded-lg">
                                    </div>
    ...
    <section class="  pb-24 container mx-auto bg-65894b" id="testimoni">
        ...
        <div data-aos="zoom-in" data-aos-duration="2000"
            class=" flex justify-center items-center relative px-20 responsive mx-auto">
        ...
        <div class=" grid lg:grid-cols-2 grid-cols-1 mt-16 lg:px-14">
            ...
            <div class="mx-auto ml-10 mt-4">
                ...
                <div class=" flex ml-8">
                    ...
                    <a href="https://wa.me/6287786294612" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" class=" m-2" width="40"
                    ...
                    <a href="https://www.instagram.com/unitedmuslimtours_id?igsh=MTU4Y3gzbXpyY3J2MA==" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" class=" m-2" width="40"
                            height="45" viewBox="0 0 45 45" fill="none">
    ...
    {{-- footer logo --}}
    <section>
        <img class=" mx-auto my-2" src={{ asset('img/logo.png') }} alt="Logo UMT">
    </section>
    {{-- end footer logo --}}
