<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
    <a class="sidebar-brand d-flex align-items-center justify-content-center" style="background-color: white" href="{{ asset('') }}index.html">
        <div class="sidebar-brand-icon">
            <img src="{{ asset('img/logo/umt.png') }}" width="100%">
        </div>
    ...
    <li class="nav-item">
        ...
        <div id="collapseForm" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded mt-2">
                ...
                <a class="collapse-item" href="{{ route('index.trip.akan.datang') }}">Trip Akan Datang</a>
                <a class="collapse-item" href="{{ route('index.trip.selesai') }}">Trip Selesai</a>
            </div>
        </div>
    </li>
