...
Route::controller(FrontController::class)->group(function () {
    ...
    Route::get('/galeri', 'galeri')->name('front.galeri');
    Route::get('/filter/galeri/{id}', 'filterGaleri')->name('filter.galeri');
    Route::get('/ready', 'ready')->name('front.ready');
    ...
    Route::get('/detail/destinasi', 'detailDestinasi')->name('front.detail.destinasi');
    Route::get('/view/destinasi', 'viewDestinasi')->name('front.view.destinasi');
    Route::get('/desc/destinasi/{id}', 'descDestinasi')->name('front.desc.destinasi');
    Route::get('/detail/itinerary/{id}', 'detailItinerary')->name('front.detail.itinerary');
    Route::get('/hubungi/kami', 'hubungiKami')->name('front.hubungi.kami');
    Route::get('/destinasi/search', 'searchDestinasi')->name('search.destinasi');
});
...
Route::prefix('admin')->middleware(['auth', 'isAdmin'])->group(function() {
    ...
    Route::controller(KategoriProdukController::class)->group(function () {
        Route::get('/kategori/produk', 'index')->name('index.kategori.produk');
        Route::post('/tambah/kategori/produk', 'tambahKategori')->name('tambah.kategori.produk');
        Route::put('/update/kategori/produk/{id}', 'updateKategori')->name('update.kategori.produk');
        Route::delete('/delete/kategori/produk/{id}', 'deleteKategori')->name('delete.kategori.produk');
